...
public final class ApplicationProducerConsumerSample
{
      ...
      public static void main(String[] args)
      {
            ...
            var lstOfConsumers = IntStream.range(0,10)
                                          .mapToObj(num-> new Thread(new MailsConsumer(CONSUMER_NAME_OPEN + num + NAME_CLOSE,
                                                                                       mailStorage,numOfMails)))
